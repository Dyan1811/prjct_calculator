...
public class Length extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECT", "Millimeter (mm)", "Centimeter (cm)", "Meter (m)", "Kilometers (km)", "Inch (in)" }));

        jComboBox4.setBackground(new java.awt.Color(255, 204, 204));
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECT", "Millimeter (mm)", "Centimeter (cm)", "Meter (m)", "Kilometers (km)", "Inch (in)" }));
