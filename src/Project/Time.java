...
public class Time extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECT", "Miliseconds (ms)", "Seconds (s)", "Minutes (min)", "Hours (h)", "Day (d)", "Sunday (wk)" }));

        jComboBox5.setBackground(new java.awt.Color(255, 204, 204));
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECT", "Miliseconds (ms)", "Seconds (s)", "Minutes (min)", "Hours (h)", "Day (d)", "Sunday (wk)" }));
